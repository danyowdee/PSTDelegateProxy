...
- (void)testDelegateBeingCalled {
    ...
    PSTDelegateProxy *delegateProxy = [[PSTDelegateProxy alloc] initWithDelegate:self forProtocol:@protocol(PSTExampleDelegate)];
...
- (void)testThatProxyCanDealWithNilledOutDelegates {
    ...
    @autoreleasepool {
        ...
        delegateProxy = [[PSTDelegateProxy alloc] initWithDelegate:delegate forProtocol:@protocol(PSTExampleDelegate)];
    }
...
- (void)testDerivedProcols {
    ...
    @autoreleasepool {
        ...
        delegateProxy = [[PSTDelegateProxy alloc] initWithDelegate:impl forProtocol:@protocol(PSTExampleDelegate)];
    }
...
- (void)testNeverCachedProperty {
    PSTDelegateProxy *delegateProxy = [[PSTDelegateProxy alloc] initWithDelegate:nil forProtocol:@protocol(NeverCachedProtocol)];
